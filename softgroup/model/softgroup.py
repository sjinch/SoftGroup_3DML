...
class SoftGroup(nn.Module):
    ...
    def __init__(self,
        ...
        # point-wise prediction / the number of layer from 2 to 3
    ...
    def point_wise_loss(self, semantic_scores, pt_offsets, semantic_labels, instance_labels,
        ...
        losses['semantic_loss'] = 2*semantic_loss
        ...
        losses['offset_loss'] = 2*offset_loss
        return losses
    ...
    def instance_loss(self, cls_scores, mask_scores, iou_scores, proposals_idx, proposals_offset,
        ...
        losses['mask_loss'] = 0.5*mask_loss
        ...
        losses['iou_score_loss'] = 0.5*iou_score_loss
        return losses
    # loss function re-define
